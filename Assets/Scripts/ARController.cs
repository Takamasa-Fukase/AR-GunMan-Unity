...
{    
    ...
    Camera cam;
    private readonly List<ShotBullet> shotBullets = new();
    ...
    private void Awake()
    {
        ...
        pistol = currentPistolParent.transform.Find("colt1911").gameObject;
    ...
    public void HandleOnCollisionEnterToTargetObject(Collision collision, GameObject targetObject)
    {
        ...
        if (hitTargetObject != null)
        {
            ...
            targets.Remove(hitTargetObject);
        }
    }
    ...
    private void KeepPistolPositionAndAngleToFPSIsh()
    {
        ...
        currentPistolParent.transform.SetPositionAndRotation(cam.transform.position, cam.transform.rotation);
